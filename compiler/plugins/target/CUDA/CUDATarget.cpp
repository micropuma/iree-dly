...
struct CUDAOptions {
  ...
  // override bindOptions to bind parameter.
...
public:
  ...
  getDefaultDeviceTarget(MLIRContext *context,
    ...
    // 通过解读将context传入builder，解读出在当前的context中注册的deviceConfigAttrs和executableConfigAttrs。
    Builder b(context);
    ...
    // mlir中的get方法：
    // 这个 get 方法的作用是根据传入的参数，
    // 生成一个 DeviceTargetAttr 类型的对象。
